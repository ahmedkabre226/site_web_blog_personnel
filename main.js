// main.js - Scripts d'interactivité pour le portfolio de KABRE KELA ISMAEL
// Auteur: Ismaël KELA KABRE
// Description: Scripts JavaScript pour le portfolio personnel
// Version: 1.0.0
// Date: 2025
// Licence: MIT
...
function handleImageLoading() {
    ...
    images.forEach(img => {
        ...
        if (img.complete) {
            ...
            // Ajouter un effet de chargement seulement si l'image n'est pas encore chargée
            img.style.opacity = '0';
